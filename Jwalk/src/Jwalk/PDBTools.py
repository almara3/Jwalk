...
class Vector:
    ...
    def to_atom(self):
        ...
        Return:
            Atom instance
        """
        # template = ('ATOM      1  C   NOR A   1      23.161  39.732 -25.038  1.00 10.00'
        #             '             C')
        a = BioPyAtom([])
        a.x = self.x
        a.y = self.y
...
'''
    ...
    def get_extreme_values(self):
        ...
        Return:
            A 6-tuple containing the minimum and maximum of x, y and z co-ordinates of the
            structure. Given in order (min_x, max_x, min_y, max_y, min_z, max_z).
...
class BioPyAtom:
    ...
    def __repr__(self):
        return f'({self.get_res()} {self.res_no} {self.chain}: {self.x}, {self.y}, {self.z})'
    ...
    def map_grid_position(self, densMap):
        ...
        Return:
              The co-ordinates and density value of the grid point in a density map closest to this
              atom. Return 0 if atom is outside of map.
        """
