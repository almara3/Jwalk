...
Tool from Josh Bullock/Topf Lab ([Topf-Lab/Jwalk](https://github.com/Topf-Lab/Jwalk)) to calculate SASDs.
Expanded for retrieving amino acid residues along the path of the SASD
...
<pdb>_<xl_list>_crosslink_list.txt
<pdb>_<xl_list>crosslinks.pdb

## TEST / RUNNING FROM PYTHON

Have a look at the  [test_jwalk.py](test_jwalk.py) file.

## COPYRIGHT

Copyright 2016 Jwalk Inventor and Birkbeck College University of London.
                    The Jwalk Inventor is: Josh 
